...
class AccountController extends Controller
{
    ...
    public function registerAction()
    {
        ...
        } else if (!$this->db_manager->get('Users')->isUniqueUserName($user_name)) {
    ...
    public function indexAction()
    {
        ...
        $followings = $this->db_manager->get('Users')
    ...
    public function followAction()
    {
        ...
        $following_user = $this->db_manager->get('Users')->fetchByUserName($following_name);
        if (!$following_user) {
            $this->forward404();
        }
        ...
        if ($user !== $following_user['id']
            && !$following_repository->isFollowing($user['id'], $following_user['id']))
        {
